...
Route::group(['prefix' => 'generalSetting'], function(){
    ...
    Route::get('/generalShow',[GeneralSettingController::class,'show'])->name('general.show');  // show all pro
    Route::post('/generalShow',[GeneralSettingController::class,'insert'])->name('general.insert');  // show all pro
