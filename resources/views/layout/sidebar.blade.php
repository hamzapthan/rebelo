    ...
    <div class="sidebar-body">
      <ul class="nav">
       ...
       <li class="nav-item">
        ...
        <div class="collapse {{ show_class(['admin/subCategory/*'])  }}" id="subCategory">
          <ul class="nav sub-menu">
          @can('subCat-create')
            <li class="nav-item">
            ...
            @can('subCat-list')
            <li class="nav-item">
            <a href="{{ route('show.pro.all') }}" class="nav-link {{  request()->routeIs('show.pro.all') ? 'active' : '' }}">Show</a>
            </li>
           @endcan
          </ul>
        </div>
